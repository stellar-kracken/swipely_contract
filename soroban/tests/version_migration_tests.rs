...
mod tests {
    ...
    fn test_initialize_migration() {
        ...
        let result = EnhancedMigrationHelper::initialize(&env, admin, initial_version);
    ...
    fn test_get_version_default() {
        ...
        let version = EnhancedMigrationHelper::get_version(&env);
    ...
    fn test_create_state_snapshot() {
        ...
        let result = EnhancedMigrationHelper::create_state_snapshot(
            &env,
            admin,
            description,
            data,
    ...
    fn test_begin_migration() {
        ...
        let result = EnhancedMigrationHelper::begin_migration(&env, admin, target_version);
    ...
    fn test_begin_migration_unauthorized() {
        ...
        let result = EnhancedMigrationHelper::begin_migration(&env, unauthorized, target_version);
    ...
    fn test_complete_migration() {
        ...
        let result = EnhancedMigrationHelper::complete_migration(
            &env,
            initial_version,
        ...
        let current_version = EnhancedMigrationHelper::get_version(&env);
    ...
    fn test_validate_state() {
        ...
        let result = EnhancedMigrationHelper::validate_state(
            &env,
    ...
    fn test_get_history() {
        ...
        let history = EnhancedMigrationHelper::get_history(&env);
    ...
    fn test_get_snapshots() {
        ...
        let snapshots = EnhancedMigrationHelper::get_snapshots(&env);
    ...
    fn test_add_migrator() {
        ...
        let result = EnhancedMigrationHelper::add_migrator(&env, admin, new_migrator);
    ...
    fn test_remove_migrator() {
        ...
        let result = EnhancedMigrationHelper::remove_migrator(&env, admin, new_migrator);
    ...
    fn test_migration_workflow() {
        ...
        // Create snapshot
        let data = Map::new(&env);
        let snapshot_result = EnhancedMigrationHelper::create_state_snapshot(
            &env,
            admin.clone(),
        ...
        let begin_result = EnhancedMigrationHelper::begin_migration(&env, admin.clone(), v2.clone());
        assert!(begin_result.is_ok());

        // Validate state
        let errors = Vec::new(&env);
        let warnings = Vec::new(&env);
        let validate_result = EnhancedMigrationHelper::validate_state(
            &env,
            ValidationCheckpoint::PostMigration,
            errors,
            warnings,
        ...
        // Complete migration
        let complete_result = EnhancedMigrationHelper::complete_migration(
            &env,
            v1,
            v2.clone(),
            admin.clone(),
        ...
        let final_version = EnhancedMigrationHelper::get_version(&env);
