...
mod tests {
    ...
    fn test_initialize_recovery() {
        ...
        let result = EmergencyFundRecovery::initialize_recovery(
            env.clone(),
            admin,
            172_800, // 48 hours
        );
    ...
    fn test_initialize_recovery_invalid_timelock_zero() {
        ...
        let result = EmergencyFundRecovery::initialize_recovery(env.clone(), admin, 0);
    ...
    fn test_enable_emergency_recovery() {
        ...
        // Enable recovery
        let result = EmergencyFundRecovery::enable_emergency_recovery(env.clone(), admin);
    ...
    fn test_enable_emergency_recovery_unauthorized() {
        ...
        let result = EmergencyFundRecovery::enable_emergency_recovery(env, user);
    ...
    fn test_add_recovery_authorizer() {
        ...
        // Add authorizer
        let result = EmergencyFundRecovery::add_recovery_authorizer(
            env.clone(),
            admin,
            user,
            true,  // can_initiate
        ...
        assert!(
            result.is_ok(),
            "Adding recovery authorizer should succeed"
        );
    }
    ...
    fn test_initiate_recovery_without_emergency_enabled() {
        ...
        let result = EmergencyFundRecovery::initiate_recovery(
            env.clone(),
            user,
            destination,
            token_address,
    ...
    fn test_approve_recovery() {
        ...
        let destination = Address::generate(&env);
        let token_address = Address::generate(&env);
        let recovery_id = EmergencyFundRecovery::initiate_recovery(
            env.clone(),
            user.clone(),
            destination,
            token_address,
        ...
        // Approve recovery
        let result = EmergencyFundRecovery::approve_recovery(env, user, recovery_id);
    ...
    fn test_get_recovery() {
        ...
        // Get recovery
        let result = EmergencyFundRecovery::get_recovery(env, recovery_id);
    ...
    fn test_get_total_recovered() {
        ...
        let total = EmergencyFundRecovery::get_total_recovered(env);
